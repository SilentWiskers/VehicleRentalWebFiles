...
<h3>ESSN</h3>
<input type="input" name="essn" class="box" placeholder="SSN" aria-controls="example" required>
<h3>Salary</h3>
<input type="input" name="salary" class="box" placeholder="Salary" aria-controls="example" required>
</div>
